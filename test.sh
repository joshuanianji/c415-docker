...
cmake -DCMAKE_BUILD_TYPE=Debug -DCMAKE_MAKE_PROGRAM=ninja -G Ninja -S /app/tests/generator-joshuanianji -B /app/tests/generator-joshuanianji/cmake-build-debug

cmake --build /app/tests/generator-joshuanianji/cmake-build-debug --target all -j 8